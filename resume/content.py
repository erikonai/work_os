...
GENERAL = {
    ...
    "experience": [
        {"title": "Director of Finance", "company": "april", "dates": "12/2024 – Present · New York, NY",
         "bullets": [
             (None, "First finance hire; built the entire function from zero and run it as sole senior leader across FP&A, Accounting, Revenue Operations, Compliance, and Treasury for a $25M run-rate Series B fintech running U.S. and Israeli entities."),
             ...
             (None, "Rebuilt pricing end to end and armed the CRO with a selling tool, not a rate sheet: unit economics set the gross-margin floors reps could discount freely inside, a platform fee billed on top of filing usage, and vertical bundles, growing the same 28-partner book from $7.4M to $17.2M at 158% NRR."),
