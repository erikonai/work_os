    ...
    "experience": [
        {"title": "Director of Finance", "company": "april", "dates": "12/2024 – Present · New York, NY",
         "bullets": [
             ...
             (None, "Partnered with the CRO to rebuild pricing as a selling tool, not a rate sheet: unit economics set the gross-margin floors reps could discount freely inside, a platform fee billed on top of filing usage, and vertical bundles with worked deals, nearly doubling the book to a $25M run rate at 158% NRR."),
